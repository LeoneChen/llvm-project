...
if(APPLE)
  ...
  set(SLSAN_COMMON_SUPPORTED_ARCH ${SANITIZER_COMMON_SUPPORTED_ARCH})
  ...
  list_intersect(LSAN_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(SLSAN_SUPPORTED_ARCH
    ALL_SLSAN_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(UBSAN_COMMON_SUPPORTED_ARCH
    ${SANITIZER_COMMON_SUPPORTED_ARCH})
  filter_available_targets(SLSAN_COMMON_SUPPORTED_ARCH
    ${SANITIZER_COMMON_SUPPORTED_ARCH})
  ...
  filter_available_targets(SLSAN_SUPPORTED_ARCH ${ALL_SLSAN_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS asan;dfsan;msan;hwasan;tsan;safestack;cfi;scudo_standalone;ubsan_minimal;gwp_asan;asan_abi;slsan)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND SLSAN_SUPPORTED_ARCH AND OS_NAME MATCHES "Linux")
  set(COMPILER_RT_HAS_SLSAN TRUE)
else()
  set(COMPILER_RT_HAS_SLSAN FALSE)
endif()
